    ...
    <div className="min-h-screen bg-espresso flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 sm:px-12">
        ...
        >
          ...
          <button className="w-full border border-white/10 rounded-xl py-3.5 text-offwhite font-medium hover:bg-white/5 transition-colors flex items-center justify-center gap-3">
